<script>
    ...
    function calculateRevenue() {
      ...
      total_revenue = 0;
        ...
        // data.forEach((item) => {
        let revenue = hashTable.get(data[i]["Название товара"]) || 0;
        revenue += data[i]["Общая стоимость"];
        hashTable.updateOrInsert(data[i]["Название товара"], revenue)
    ...
    <div class="flex justify-between items-start w-full pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
      <div class="flex-col items-center">
        <div class="flex items-center">
          ...
          <div>
            <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-1">Топ 5 товаров (по выручке)</h5>
